	...
	render() {
		return (
			<div className="input-group">
				<div className="input-group-prepend mb-1" style={{vertialAlign:"center"}}>
					<input className="mb-1" type="checkbox" onClick={() => this.props.checkBox(this.props.item.pk, this.props.type)} checked={this.props.checked} />
				</div>
