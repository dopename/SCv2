		...
		return (
			<div className="input-group">
				<div className="input-group-prepend">
					<input style={{verticalAlign:"middle", display:"inline-block"}} type="checkbox" onClick={() => this.props.checkBox(this.props.item.pk, this.props.type)} checked={this.props.checked} />
				</div>
