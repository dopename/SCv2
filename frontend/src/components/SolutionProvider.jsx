				...
				<div className="row">
					...
					<div className="col-lg-10 m-auto">
						...
						<div className="col-12 border-bottom">
							<p className="d-inline mx-2 text-primary"><strong>Overview</strong></p>
							<p className="d-inline mx-2 text-primary"><strong>Solutions</strong></p>
							<p className="d-inline mx-2 text-primary"><strong>About</strong></p>
						</div>
						<div className="row my-4 pt-2">
							<div className="col-lg-6">
								<div className="provider-tags p-2">
									<p className="text-left"><strong>We make solutions for:</strong></p>
									{this.props.providerData ? <Tags tags={this.props.providerData.child_tags} /> : <div className="loader"></div>}
								</div>
							</div>
							<div className="col-lg-6">
								<div className="provider-tags p-2">
									<p className="text-left"><strong>Industries we're in:</strong></p>
